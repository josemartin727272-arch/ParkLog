...
const TRANSLATIONS = {
  es: {
    ...
    'entry.location.large': 'Estacionamiento Grande',
    'entry.location.small': 'Estacionamiento Pequeño',
    'entry.location.public': 'Estacionamiento Público',
    'entry.location.error': 'Selecciona una ubicación',
    'entry.location.warning': '⚠️ Este vehículo ya fue registrado hoy en otra estación',
  ...
  he: {
    ...
    'entry.location.large': 'חניון גדול',
    'entry.location.small': 'חניון קטן',
    'entry.location.public': 'חניון ציבורי',
    'entry.location.error': 'יש לבחור מיקום',
    'entry.location.warning': '⚠️ רכב זה כבר נרשם היום בתחנה אחרת',
