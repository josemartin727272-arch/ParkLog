...
├── commandcenter.js       ← Charts, filters, KPIs, exports, settings
...
| entry_type | String | Yes | `vehicle` (default) or `persona` |
| person_id | String | No | FK to Persons — populated only when entry_type = `persona` |
